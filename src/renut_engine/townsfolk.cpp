...
REXCVAR_DEFINE_BOOL(disable_townsfolk, false, "Nuts&Bolts/Showdown Town", "Stops the wandering Showdown Town townsfolk from spawning. Named characters " "(Mumbo, Humba Wumba, ...) are unaffected. Applies as you move around town.");
